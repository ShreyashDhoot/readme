...
**HCLTech | Pragya Labs, BITS Goa | Heera Software**

[Website](https://shreyashdhoot.github.io) · [GitHub](https://github.com/ShreyashDhoot) · [LinkedIn](www.linkedin.com/in/shreyash-dhoot) · [Email](mailto:shreyashdhoot@gmail.com) · [GoogleScholar](https://scholar.google.com/citations?hl=en&user=jNGNH4IAAAAJ) 
...
A B2B SaaS platform for the construction industry, closing the communication gap between site personnel and management with an end-to-end snag detection, assignment, and closure pipeline across multi-building projects.
 
- WhatsApp-native defect reporting pipeline — supports voice, image, and multilingual text input straight from the site
- Gemini API auto-categorises reported snags into Safety, Design, Resource, and Quality, with AI-generated resolution suggestions
...
- [**Stochastic Chaos**](https://arxiv.org/pdf/2601.07239) — proving emergent model properties are a factor of both the model size and the stochastic decoding policy, arguing that distributional variability is the heartbeat of artificial cognition.
...
`PyTorch` · `Stable Diffusion (1.5 / XL / 3.5)` · `FLUX.1` · `LoRA` · `FastAPI` · `OpenCV` · `Pinecone` · `Data Modeling` · `Multimodal LLMs` · `Qwen VLM` · `Qwen 35b instruct` 

---

<div align="center">
<sub>Open to research collaborations and opportunities in ML/CV/AI safety. Reach out — I'd genuinely love to talk.</sub>
</div>